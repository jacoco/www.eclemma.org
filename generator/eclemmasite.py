...
site.item('images/mtrail.png', File('content/images/mtrail.png'))
...
site.item('jacoco/trunk/doc/index.html',      File('../jacoco-snapshot/doc/index.html'))
site.item('jacoco/trunk/doc/changes.html',    File('../jacoco-snapshot/doc/changes.html'))
site.item('jacoco/trunk/doc/repo.html',       File('../jacoco-snapshot/doc/repo.html'))
site.item('jacoco/trunk/coverage/index.html', File('../jacoco-snapshot/coverage/index.html'))
