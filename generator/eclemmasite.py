...
site.item('images/topic.gif', File(SITEBASE, 'content/images/topic.gif'))
site.item('images/container.gif', File(SITEBASE, 'content/images/container.gif'))
...
site.item('images/finalist.png', File(SITEBASE, 'content/images/finalist.png'))
